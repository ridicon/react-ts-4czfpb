...
var ImageViewer = function (_React$Component) {
    ...
    (0, _createClass3.default)(ImageViewer, [{
        ...
        value: function getContent() {
            ...
            return React.createElement(react_native_1.Animated.View, { style: [this.styles.container, { opacity: this.fadeAnim }] }, this.props.renderHeader(), React.createElement(react_native_1.View, { style: this.styles.arrowLeftContainer }, React.createElement(react_native_1.TouchableWithoutFeedback, { onPress: this.goBack.bind(this) }, React.createElement(react_native_1.View, null, this.props.renderArrowLeft()))), React.createElement(react_native_1.View, { style: this.styles.arrowRightContainer }, React.createElement(react_native_1.TouchableWithoutFeedback, { onPress: this.goNext.bind(this) }, React.createElement(react_native_1.View, null, this.props.renderArrowRight()))), React.createElement(react_native_1.Animated.View, { style: [this.styles.moveBox, { transform: [{ translateX: this.positionX }] }, { width: this.width * this.props.imageUrls.length }] }, ImageElements), this.props.imageUrls.length > 0 && this.props.renderIndicator(this.state.currentShowIndex + 1, this.props.imageUrls.length), this.props.imageUrls[this.state.currentShowIndex].originSizeKb && this.props.imageUrls[this.state.currentShowIndex].originUrl && React.createElement(react_native_1.View, { style: this.styles.watchOrigin }, React.createElement(react_native_1.TouchableOpacity, { style: this.styles.watchOriginTouchable }, React.createElement(react_native_1.Text, { style: this.styles.watchOriginText }, "查看原图(2M)"))), this.props.renderFooter());
        }
    }, {
        key: "saveToLocal",
